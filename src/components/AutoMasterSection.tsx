      ...
      <div className="am-container">
        ...
        >
          ...
          >
            ...
            <motion.div className="am-problem-card-v2" variants={cardVariant} whileHover={{ y: -8 }}>
              ...
              <p className="am-card-text">Thousands of old leads sitting untouched. Those people are buying cars elsewhere.</p>
              <div className="am-card-stat">
            ...
            <motion.div className="am-problem-card-v2" variants={cardVariant} whileHover={{ y: -8 }}>
              ...
              <p className="am-card-text">High payroll. High turnover. Constant training. Leads still slip through cracks.</p>
              <div className="am-card-stat">
            ...
            <motion.div className="am-problem-card-v2" variants={cardVariant} whileHover={{ y: -8 }}>
              ...
              <div className="am-card-icon">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M16.5 3.5l-3 3m0-3l3 3" />
                </svg>
              </div>
              <div className="am-card-number">04</div>
              <h4 className="am-card-title">Missed Service Calls</h4>
              <p className="am-card-text">Phone rings. Voicemail picks up. Every missed call is a missed RO.</p>
              <div className="am-card-stat">
          ...
          <div className="wwa-grid">
            ...
            >
              ...
              <h3 className="wwa-headline">
                Built by <span className="wwa-highlight">car people</span>,<br />
                for car people.
              </h3>
            ...
            >
              ...
              <div className="wwa-stats-row">
                <div className="wwa-stat">
                  ...
                  <span className="wwa-stat-label">Years Combined<br />Auto Experience</span>
                </div>
                <div className="wwa-stat">
                  <span className="wwa-stat-num">100+</span>
                  <span className="wwa-stat-label">Dealerships<br />Served</span>
                </div>
                <div className="wwa-stat">
                  <span className="wwa-stat-num">$35M+</span>
                  <span className="wwa-stat-label">Revenue<br />Generated</span>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        >
          ...
          <motion.div
            ...
            variants={staggerContainer}
          >
            <motion.article className="am-blog-card" variants={cardVariant} whileHover={{ scale: 1.02, y: -8 }}>
